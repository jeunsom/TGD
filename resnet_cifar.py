...
class ResNet_Cifar(nn.Module):
    ...
    def __init__(self, block, layers, in_channel = 3, num_classes=10):
        ...
        self.avgpool = nn.AvgPool2d((8,8), stride=1) #nn.AvgPool2d(8, stride=1)
        self.fc = nn.Linear(64 * block.expansion, num_classes) #64 * block.expansion
    ...
    def forward(self, x):
        ...
        x = nn.functional.adaptive_avg_pool2d(x3, 1)


        #print('shape : ', x.shape) #128x64x1x1
        x = x.view(x.size(0), -1)
        #print('shape1 : ', x.shape) #64x7552 #128x64
        x = self.fc(x)
        #print('shape2 : ', x.shape) #128x100
