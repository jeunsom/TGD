...
class WideResNet(nn.Module):
    ...
    def __init__(self, d, k, num_classes, input_features, output_features, strides):
        ...
        self.activation = nn.ReLU(inplace=True)
        self.avg_pool = nn.AdaptiveAvgPool2d((1, 1)) #nn.AvgPool2d(kernel_size=8)
...
def WRN16_1(progress=True, input_features=3, **kwargs):
    strides = [1, 1, 2, 2]
    return WideResNet(d=16, k=1, num_classes=10, input_features=input_features, output_features=16, strides=strides) #input_features=3

def WRN16_2(progress=True, input_features=3,**kwargs):
    strides = [1, 1, 2, 2]
    return WideResNet(d=16, k=2, num_classes=10, input_features=input_features, output_features=16, strides=strides)

def WRN16_3(progress=True,input_features=3, **kwargs):
    strides = [1, 1, 2, 2]
    return WideResNet(d=16, k=3, num_classes=10, input_features=input_features, output_features=16, strides=strides)

def WRN16_4(progress=True, input_features=3,**kwargs):
    strides = [1, 1, 2, 2]
    return WideResNet(d=16, k=4, num_classes=10, input_features=input_features, output_features=16, strides=strides) #output_features=16

def WRN16_5(progress=True,input_features=3, **kwargs):
    strides = [1, 1, 2, 2]
    return WideResNet(d=16, k=5, num_classes=10, input_features=input_features, output_features=16, strides=strides)

def WRN16_6(progress=True,input_features=3, **kwargs):
    strides = [1, 1, 2, 2]
    return WideResNet(d=16, k=6, num_classes=10, input_features=input_features, output_features=16, strides=strides)

def WRN16_8(progress=True, input_features=3,**kwargs):
    strides = [1, 1, 2, 2]
    return WideResNet(d=16, k=8, num_classes=10, input_features=input_features, output_features=16, strides=strides)

def WRN28_1(progress=True, input_features=3,**kwargs):
    strides = [1, 1, 2, 2]
    return WideResNet(d=28, k=1, num_classes=10, input_features=input_features, output_features=16, strides=strides)

def WRN28_3(progress=True,input_features=3, **kwargs):
    strides = [1, 1, 2, 2]
    return WideResNet(d=28, k=3, num_classes=10, input_features=input_features, output_features=16, strides=strides)

def WRN28_6(progress=True,input_features=3, **kwargs):
    strides = [1, 1, 2, 2]
    return WideResNet(d=28, k=6, num_classes=10, input_features=input_features, output_features=16, strides=strides)

def WRN40_1(progress=True, input_features=3,**kwargs):
    strides = [1, 1, 2, 2]
    return WideResNet(d=40, k=1, num_classes=10, input_features=input_features, output_features=16, strides=strides) #input_features=3

def WRN40_2(progress=True, input_features=3,**kwargs):
    strides = [1, 1, 2, 2]
    return WideResNet(d=40, k=2, num_classes=10, input_features=input_features, output_features=16, strides=strides)

def WRN40_3(progress=True, input_features=3,**kwargs):
    strides = [1, 1, 2, 2]
    return WideResNet(d=40, k=3, num_classes=10, input_features=input_features, output_features=16, strides=strides)
